...
import com.dot2dotz.app.Models.FeedbackResponse;
...
public interface ApiInterface {
    ...
    @FormUrlEncoded
    Call<ResponseBody> updateFavoriteLocations(@Header("X-Requested-With") String xmlRequest,
                                               @Header("Authorization") String strToken,
    ...
    @FormUrlEncoded
    Call<ResponseBody> accessAPI(@Header("X-Requested-With") String xmlRequest,
                                 @Field("username") String username,
                                 @Field("accesskey") String accesskey);

    @GET(URLHelper.GET_FEEDBACK)
    Call<FeedbackResponse> getFeedBack(@Header("X-Requested-With") String xmlRequest,
                                       @Header("Authorization") String strToken);
